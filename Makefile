...
lint-py:  ## run python linter with ruff
	python -m ruff check spaday_studio
	python -m ruff format --check spaday_studio
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix spaday_studio
	python -m ruff format spaday_studio
...
test-py:  ## run python tests
	python -m pytest -v spaday_studio/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v spaday_studio/tests --cov=spaday_studio --cov-report term-missing --cov-report xml
